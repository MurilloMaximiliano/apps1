    ...
    return (
      <div className="pageContainer">
        <Container className="mainContainer documentContainer postContainer">
          ...
          <h3>MurilloMAX</h3>
          <p>
            The core of <strong>Murillo</strong> is worked on full-time by
          ...
          <p>
            ...
            following playlists:{' '}
            <a href="https://www.youtube.com/watch?v=CbI5hTtMUq0&list=RDCbI5hTtMUq0&start_radio=1">
              React Conf 2017
            </a>
            {', '}
